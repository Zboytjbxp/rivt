...
const SAFE_RECOVERY_FAILURE_MESSAGES = {
  ...
  RECOVERY_WRITER_AUTHORIZATION_INVALID: "Protected-writer authorization was not bound to the reviewed recovery set.",
  RECOVERY_WRITER_AUTHORIZATION_REQUIRED: "A reviewed protected-writer authorization adapter is required.",
  RECOVERY_WRITER_REVOCATION_UNVERIFIED: "Protected-writer authority could not be proven inert after the attempt.",
  RECOVERY_WRITER_RETIREMENT_CONTROLLER_REQUIRED: "An independent writer-retirement controller is required.",
  RECOVERY_WRITER_RETIREMENT_REGISTRATION_INVALID: "Independent writer retirement was not durably registered.",
  RECOVERY_WRITER_RETIREMENT_UNVERIFIED: "Independent writer retirement could not be verified.",
  RECOVERY_RETIREMENT_WINDOW_INVALID: "The independent retirement proof window is invalid.",
