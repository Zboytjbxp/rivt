...
test("Profile hub renders without crashing", async () => {
  ...
  assertSmokeRender(
    React.createElement(ProfileHub, {
      ...
      themeMode: "light",
      themeSource: "light",
      themeAccent: "rivtOrange",
      themeChrome: "graphite",
      themeCanvas: "clean",
      themeCustomColor: "#ff4b00",
      themeDensity: "field",
      onSetThemeSource: noop,
      onSetThemeAccent: noop,
      onSetThemeChrome: noop,
      onSetThemeCanvas: noop,
      onSetThemeCustomColor: noop,
      onSetThemeDensity: noop,
