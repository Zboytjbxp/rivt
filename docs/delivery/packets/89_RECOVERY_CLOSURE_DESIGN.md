...
question. R-052 remains open until the durable, scheduled, independently
...
- The recovery hardening portfolio is the decision artifact for the next
  owner review.
- R-052 remains a public-launch blocker.
...
- `npm run launch:readiness -- --require-ready` passed. That machine gate
  validates the approved policy record; it does not override R-052 or prove
