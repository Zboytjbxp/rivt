...
- Production source `535e21bf1c2b76c7547b9c5ac5dc9ef54b8d5b79` serves migration `0024_push_subscription_sessions`; health and the synthetic monitor report Web Push configured without exposing keys. Maturity is `production configured`; one closed-PWA physical notification delivery/click and post-logout non-delivery proof remain before `production verified`.
