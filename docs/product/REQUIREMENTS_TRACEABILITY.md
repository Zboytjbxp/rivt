...
- Authentication has fail-open client behavior and unsafe OAuth onboarding defaults.
- First implementation priority is security/storage-boundary correction, not additional UI modules.
