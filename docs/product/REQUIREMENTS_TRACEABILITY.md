...
- Release candidate `codex/final-release-candidate-20260804` is at
  `b17043a6c2f7b708675f3a155ac2dbf09dcd8e86`. It contains integration merge
...
- ACH remains disabled and `ACTIVE_LAUNCH_HOLD` remains active. Backup
  ...
  unproved. `GA-OPS-004` and `GA-OPS-009` remain **Blocker**. Final exact-
  candidate gate counts and readiness are pending; historical packet counts
  below must not be treated as final release evidence.
...
- `GA-OPS-007` remains **Partial**. Root Codex and Claude instructions now
  ...
  reports only paths and rule identifiers. Historical Packet 99 checks are
  retained in packet records, but final gate counts, database-backed coverage,
  and readiness for exact candidate
...
| GA-OPS-004 | Backup and timed restore drill pass | Blocker | Historical June restores and the approved 2026-08-02 same-provider artifact remain historical evidence only. Production/`origin/master` source `7ee9b30a77bbed2cb1ca4aeda330066884e3d59b` contains PR #22 source-only backup tooling. Candidate `b17043a6c2f7b708675f3a155ac2dbf09dcd8e86` adds hardened scheduler source, but no scheduler service, independent retention provider, recurring artifact, exact current-artifact restore, or required object-byte restore is activated or proved. Keep `R-052` open. Exit requires approved monitored recurrence, independent retention, isolated restoration of the exact current artifact, integrity-checked restoration of every required object byte, and recurring restore-drill evidence. |
