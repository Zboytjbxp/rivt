...
- `GA-OPS-007` gains exact local evidence from implementation commit
  ...
  integrity. Branch `codex/railway-replica-safety` was pushed through
  documentation commit `b1b5fa3`; it has not been merged or deployed.
