...
- Full Gate A approval remains blocked by live backup-artifact restore/RPO acceptance, external observability/alerts, support/legal/founder signoff, and physical/deeper manual accessibility/device evidence.
