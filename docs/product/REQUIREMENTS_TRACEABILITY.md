...
- Full Gate A approval remains blocked by restore drill evidence, external observability/alerts, support/legal/founder signoff, and manual accessibility/device evidence.
