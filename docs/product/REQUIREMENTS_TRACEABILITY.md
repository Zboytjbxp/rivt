...
- Requirement maturity remains Partial because explicit decisions for
  unobservable VAPID/backup-key/authentication-pepper misuse and a fresh Railway
  Stage 1 re-review and approval remain open. The bounded Stripe platform-
