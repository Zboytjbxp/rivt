...
- Railway service config: `railway.backup.json`
...
- External monitor: `.github/workflows/backup-freshness.yml`
...
6. Create a Railway cron service from the reviewed commit and
   `railway.backup.json`, with no public domain and the 12-hour schedule.
